package com.intutrack.intudock.Preference;
...
public class Preferences {
    ...
    public static void storeWarehouseList(Context context, List<WarehouseResult> payload3) {
        ...
        editor.putString(PrefEntities.WAREHOUSE, json);
        editor.apply();
    }

    public static ArrayList<WarehouseResult> loadWarehouseList(Context context) {
        SharedPreferences preferences;
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String json = preferences.getString(PrefEntities.WAREHOUSE, null);
        Type type = new TypeToken<List<WarehouseResult>>() {
        }.getType();
        return gson.fromJson(json, type);
    }

    public static void storeDocksList(Context context, List<DocksResult> payload3) {
        SharedPreferences preferences;
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        Gson gson = new Gson();
        String json = gson.toJson(payload3);
        editor.putString(PrefEntities.DOCKS, json);
        editor.apply();
    }

    public static ArrayList<DocksResult> loadDocksList(Context context) {
        SharedPreferences preferences;
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String json = preferences.getString(PrefEntities.DOCKS, null);
        Type type = new TypeToken<List<DocksResult>>() {
        }.getType();
        return gson.fromJson(json, type);
    }

    public static void storeTransactionsList(Context context, List<TransactionsResult> payload3) {
        SharedPreferences preferences;
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        Gson gson = new Gson();
        String json = gson.toJson(payload3);
        editor.putString(PrefEntities.TRANSACTIONS, json);
        editor.apply();
    }

    public static ArrayList<TransactionsResult> loadTransactionsList(Context context) {
        SharedPreferences preferences;
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String json = preferences.getString(PrefEntities.TRANSACTIONS, null);
        Type type = new TypeToken<List<TransactionsResult>>() {
        }.getType();
        return gson.fromJson(json, type);
    }
